...
function sendReview () {
	socket.emit('add_user_review', {professionalism: $("#review_prof").val()/100, communication: $("#review_comm").val()/100, cleanliness: $("#review_clea").val()/100, overall: $("#review_over").val()/100, branch: $("#review_branch").val(), comments: $("#review_comment").val()})
}
